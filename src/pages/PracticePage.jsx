                    ...
                    >
                      ...
                      <td className="p-4 text-center">
                        <a
                          ...
                          className="inline-flex items-center justify-center p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors group/link"
                        ...
                        >
                          <svg
                            ...
                            className="w-5 h-5 fill-white/60 group-hover/link:fill-[#FFA116] transition-colors"
                          >
